module.exports = {
    ...
    "btext":"Get Message Via", "menuBar": {"choices": ["Command Message", "Variable*"], storeAs: "messageFrom", extraField: "message"}, 
    "sepbar0":"sepbar",
    "btext0":"Mention Number",
    "menuBar0": {"choices":["First", "Second", "Third", "Custom*"], storeAs: "position", extraField: "numericPosition"},
    ...
    preview: "position", previewName: "Mention"},
    run(values, message, uID, fs, client, runner, bridge)  {
        ...
        switch (values.position) {
            ...
            break
            case 'Custom':
                mention = mentions[parseFloat(varTools.transf(values.numericPosition, bridge.variables))]
            break
        }
