module.exports = {
    data: {
    "name": "Timeout Member", "memberFrom": "Variable*", "member": "", "reason":"", "duration":"Minute(s)*", "howMuch":""},
    ...
    "btext0": "Duration",
    "menuBar0":{"choices": ["Day(s)*", "Hour(s)*", "Minute(s)*", "Second(s)*"], "storeAs":"duration", "extraField":"howMuch"} ,
    
    "sepbar1":"",

    "btext1":"Reason", 
    "input":"reason",
    preview: "memberFrom", previewName: "Member",
