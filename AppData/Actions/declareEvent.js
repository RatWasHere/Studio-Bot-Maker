module.exports = {
    ...
    UI: {"compatibleWith":["None"], "text": "Declare Event","sepbar":"sbar", "btext69":"Store As", "input777*":"storeAs", "sepbar422":"sepbar", "menuBar": {choices: ["Message Create", "Message Delete", "Message Update", "Bot Ready", "Channel Create", "Channel Delete", "Channel Update", "Bot Joins Guild", "Bot Leaves Guild", "User Update", "Member Leave", "Member Join", "Member Ban", "Member Kick", "Member Timeout", "Member Add Role", "Member Remove Role", "Role Create", "Role Delete", "Role Edit"], storeAs: "choice"}, "preview":"choice", "previewName":"Event"},
