module.exports = {
    ...
    "menuBar0": {"choices": ["Variable*", "Any Message In Command Channel"], storeAs: "messageFrom", extraField: "message"},
    ...
    async run(values, inter, uID, fs, client, actionRunner, bridge) { 
        ...
        if (values.stopAwaitingAfter != '') {
            setTimeout(() => {
                client.off('messageReactionAdd', handleReaction(message, reactor, reaction))
