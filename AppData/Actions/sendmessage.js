module.exports = {
    ...
    run(values, message, uID, fs, client) {
        ...
        if (values.button == "Message Channel") {
            message.channel.send({content: varTools.transf(values.messageContent, uID, tempVrz), components: interactionTools.getButtons(values.actionRowElements)}).then(msg => {
                if (values.storeAs != "") {
