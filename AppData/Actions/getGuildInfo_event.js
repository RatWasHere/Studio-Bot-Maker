module.exports = {
    data: {"name": "Get Guild Info", "storeAs":"", "toGet":"Guild Name", "guildVariable":"", "guildFrom":"Variable*"},
    UI: {"compatibleWith": ["Event"], "text":"Get Member Info", 
    
    "sepbar":"","btext":"Get Guild From", 

    "menuBar":{"choices": ["Variable*", "Guild ID*"],
    storeAs:"guildFrom", extraField:"guildVariable"},

    "sepbar0":"", "btext0":"Get", 
    "menuBar0":{"choices":["Guild Name", "Guild Icon URL", "Guild Members List", "Guild Member Count", "Guild Owner"], storeAs:"toGet"},
