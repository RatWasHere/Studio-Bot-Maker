module.exports = {
    data: {"name": "Get Interaction Info", "interaction":"", "interactionFrom":"Command Interaction", "get": "Interaction Content", "storeAs":""},
    UI: {"compatibleWith": ["Slash"],
        "text":"Get Interaction Info",
        
        "sepbar":"",

        "btext": "Get Interaction Via",
        "menuBar": {choices: ["Command Interaction", "Variable*"], storeAs: "interactionFrom", extraField: "interaction"},

        "sepbar0":"",

        "btext0": "Get",
        "menuBar0": {choices: ["Interaction Channel", "Interaction Author", "Interaction Timestamp", "Interaction ID"], storeAs: "get"},
    ...
    run(values, interaction, uID, fs, client, runner, bridge)  {
        ...
        if (values.interactionFrom == 'Variable*') {
            _interaction = bridge.variables[varTools.transf(values.interaction, bridge.variables)]
        }
