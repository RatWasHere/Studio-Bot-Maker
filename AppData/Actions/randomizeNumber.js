module.exports = {
    ...
    "btext":"Minimum",
    "input custom number <min>-999999999</min> <max>999999999</max>*":"firstNumber",
    "sepbar0":"",
    "btext0":"Maximum",
    "input custom number <min>-999999999</min> <max>999999999</max>":"secondNumber",
    "sepbar1":"noice, 69!",
    "btext1":"Store As",
    "input!":"storeAs",
    preview: "secondNumber", previewName: "Max Value"},
    subtitle: "Min Value: $[firstNumber]$ - Max Value: $[secondNumber]$ - Store As: $[storeAs]$",
