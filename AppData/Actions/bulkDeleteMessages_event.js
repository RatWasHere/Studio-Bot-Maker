module.exports = {
    ...
    UI: {"compatibleWith": ["Event"], "text":"Bulk Delete", "sepbar":"",
    "btext":"Get Messages Channel Via",
    "menuBar": {"choices": ["Variable*", "ID*"], "storeAs":"channelFrom", "extraField":"channelVariable"},
    "sepbar0":"",
    ...
    "menuBar2": {"choices": ["User*", "ID*", "Anybody"], "storeAs":"user", "extraField":"fromWho"},
    "invisible":"",
    "variableSettings": {
        "channelVariable": {
            "Variable*": "direct"
