module.exports = {
    ...
    UI: {"compatibleWith": ["Event"], "text": "Timeout Member","sepbarEmbVar":"", "btextmember":"Member Variable", "input13*":"ExtraData", "sepbarmenus":"sepbar", "btextmenus":"Guild Variable", "inputguild*":"guildfield", "sepbarguildidk":"","btextdurationtime": "Duration" ,"menuBarduration":{"choices": ["Day(s)*", "Hour(s)*", "Minute(s)*", "Second(s)*"], "storeAs":"duration", "extraField":"howMuch"} ,"sepbarguilddk":"","btextreason":"Reason", "inputreason":"reason", preview: "ExtraData", previewName: "Member Var"},
