module.exports = {
    ...
    "text": "Timeout Member","sepbarEmbVar":"",
     "btextmember":"Member",
      "menuBar1": {"choices": ["Message Author", "Variable*"], storeAs: "button", extraField: "ExtraData"},
       "sepbarmenus":"sepbar", "btextmenus":"Guild", 
       "menuBar2":{"choices": ["Message Guild", "Variable*"], storeAs: "guild", extraField: "guildField"}, 
       "sepbarguildidk":"","btextdurationtime": "Duration" ,
       "menuBarduration":{"choices": ["Day(s)*", "Hour(s)*", "Minute(s)*", "Second(s)*"], "storeAs":"duration", "extraField":"howMuch"} ,
       "sepbarguilddk":"","btextreason":"Reason", "inputreason":"reason",
        preview: "button", previewName: "Member",
        "variableSettings":{
            "howMuch": {
                "Day(s)*": "novars",
                "Hour(s)*": "novars",
