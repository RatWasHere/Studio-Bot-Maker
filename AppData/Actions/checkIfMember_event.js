module.exports = {
    ...
    "permission":"Admin", "memberVariable":"", "memberChoice":"Command Author", "guild":"", "guildFrom":""},
    ...
    "menuBar":{"choices": ["Variable*", "Member ID*"], storeAs:"memberChoice", extraField:"memberVariable"},
    ...
    async run(values, message, uID, fs, client, actionRunner, bridge) {
        ...
        if (values.guildFrom == 'Variable*') {
            guild = bridge.variables[varTools.transf(transf(values.guild), transf(bridge.variables))];
        }
