module.exports = {
    data: {"name": "Get Interaction Info", "interaction":"", "get": "Interaction Content", "storeAs":""},
    UI: {"compatibleWith": ["Text", "DM", "Event"],
    ...
    run(values, interaction, uID, fs, client, runner, bridge)  {
        ...
        let _interaction = bridge.variables[varTools.transf(values.interaction, bridge.variables)];
        let result;
        switch (values.get) {
